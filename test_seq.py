...
import json
from model.inference_test import InferenceTool, InferenceCode
...
def main():
    ...
    if not INSIDE_BLENDER:
        ...
        environment_params = {
            ...
            "blender_config_path": "./environment/blender_test.json",
            "controller_config_path": "./environment/controller_cfg.json"
        }

    with open("/media/m2data/NS_AP/NS_AP_v1_0_a/stack_weight/test/instructions.json", 'r') as f:
        instruction_struct = json.load(f)

    sequences_dir = "test/test"
    ...
    scene_json = os.path.join("/media/m2data/NS_AP/NS_AP_v1_0_a/stack_weight/test/scenes", base_fname + '.json')
