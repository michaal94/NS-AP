...
class InferenceToolDebug:
    ...
    def update_sequence_json(self, obs, last_action=None, obs_robot=None):
        ...
        joints_cos = obs['robot0_joint_pos_cos']
        joints_sin = obs['robot0_joint_pos_sin']
        joints_cs = zip(joints_cos, joints_sin)
        joints_ang = [np.arctan2(s, c) for (c, s) in joints_cs]
        joints_deg = [np.rad2deg(a) for a in joints_ang]
