...
from .visual_recognition import VisualGTLoader, AttributesBaselineTrainer, YCBAttributesTrainer, YCBAttributesTrainer2
...
TRAINERS = {
    ...
    "YCBAttributesTrainer2": YCBAttributesTrainer2
}
